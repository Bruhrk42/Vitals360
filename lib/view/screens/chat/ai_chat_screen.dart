...
class _AiPageState extends State<AiPage> {
  ...
  final List<ChatMessage> _messages = [
    ChatMessage(
      text:
          "Hello! Welcome to Vitals360 App. I'm your AI health assistant.\nHow can I help you today?",
      isBot: true,
      time: "",
    ),
  ];
  ...
  void _checkApiConfiguration() {
    if (!Vitals360AIService.isApiKeyConfigured()) {}
  }
  ...
  Future<void> _sendMessage() async {
    ...
    try {
      final response = await Vitals360AIService.generateResponse(input);
