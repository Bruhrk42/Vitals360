...
import 'package:vitals360/view/screens/onboarding/start_screen1.dart';
import 'package:vitals360/view/screens/home/home_page.dart';
import 'package:vitals360/services/user_session.dart';
...
class SplashScreenWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(
        child: Image.asset('assets/images/vitals360logo.png', width: size / 4),
      ),
    );
  }
}
